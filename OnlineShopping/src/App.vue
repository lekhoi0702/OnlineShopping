...
<template>
  <header v-if="!isAuthPage && !isSellerPage" class="site-header">
    <nav class="container account-nav" aria-label="Tài khoản">
      <RouterLink to="/seller/login"> Kênh người bán </RouterLink>
    ...
    <div class="container header-content">
      <RouterLink class="brand" to="/"> Online Shopping </RouterLink>
      ...
      <RouterLink class="cart-button cart-link" to="/cart"> Giỏ hàng </RouterLink>
    </div>
  </header>
